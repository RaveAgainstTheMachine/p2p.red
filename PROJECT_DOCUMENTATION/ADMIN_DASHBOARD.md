...
Internal admin dashboard for <domain> operations. Same stack (React + metadata-api). OpenBao-backed admin login.
...
- ⏳ Admin UI shell for `dash.<domain>` pending (login + overview + telemetry charts).
