...
### TURN-1 (Primary TURN)
- Hostname/FQDN: turn1p2pred / <turn1-domain>
- Provider: <fill>
- Region: <fill>
- Public IP: <ip>
- SSH Port: 22
...
- Hostname/FQDN: turn2p2pred / <turn2-domain>
- Provider: <fill>
- Region: <fill>
- Public IP: <ip>
- SSH Port: 22
...
## 5) TLS / Certificates
- Preferred email for Let’s Encrypt: <email>
...
We can expose a single admin domain (e.g. `ops.<domain>`) and route to dashboards.
