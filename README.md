...
- 🔗 **Short links** - 16-character shareable links (e.g., `<domain>#aB3xK9mP12345678`)
...
1. Open [<domain>](https://<domain>)
2. Drag and drop a file to share
3. Copy the short share link (e.g., `https://<domain>#aB3xK9mP12345678`)
...
|-------------|----------------------------|--------------------|-------------|
| Development | <ip>:3000             | Local development  | Free        |
| Production  | [<domain>](https://<domain>) | Live service       | $5-15/month |
...
Sender Browser                               Receiver Browser
      ...
      |                                             |
      | 2. Share link: <domain>#aB3xK9mP12345678     |
      |-------------------------------------------> |
      |                                             |
      |                                             | 3. Retrieve metadata
      |                                             |-------------------->
...
# Copy to VPS
scp -r dist/ <email>:/opt/p2p-file-share/

# Restart services
ssh <email> "cd /opt/p2p-file-share && sudo docker compose restart"
```
