        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 items-center justify-items-stretch gap-2 w-full text-[clamp(10px,2vw,13px)]">
          ...
          <div className="flex items-center justify-start shrink-0">
            {buildIndicatorClass && buildIndicatorLabel && (
              <div
                className="group relative flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-widest text-white/90"
              >
