...
export const environments: Record<string, EnvironmentConfig> = {
  ...
  production: {
    apiUrl: import.meta.env.VITE_API_URL ?? (typeof window !== 'undefined' ? window.location.origin : 'https://example.com'),
    peerJsConfig: {
      host: import.meta.env.VITE_PEERJS_HOST ?? (typeof window !== 'undefined' ? window.location.hostname : 'example.com'),
      port: Number(
