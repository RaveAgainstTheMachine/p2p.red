...
const sections: Section[] = [
    ...
    body: (
      <>
        <p>
          ...
          checksums are computed per shard to detect corruption. Corrupted shards are automatically
          retransmitted to ensure transfer success.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <p>
        Self-hosted using Docker with Caddy, PostgreSQL, and Redis. Full control over the stack — no third-party clouds storing your metadata.
      </p>
    ),
  },
];
    ...
    <div className="w-full max-w-4xl">
      ...
      <div className="mb-10">
        ...
        <p className="mt-3 text-white/50 text-base leading-relaxed max-w-2xl">
          {siteName} uses WebRTC to send files directly between browsers. Here's exactly what happens
