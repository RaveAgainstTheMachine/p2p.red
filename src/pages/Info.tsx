      ...
      <div className="relative z-10 mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="glass-card p-8">
          ...
          <div className="space-y-6 text-white/80">
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Protocol Overview</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Data Integrity & Reliability</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Adaptive Multi-Stream Transfers</h2>
              <p className="leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Metadata + Short Links</h2>
              <p className="leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Session IDs</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-3">Anti-Abuse</h2>
              <p className="leading-relaxed">
